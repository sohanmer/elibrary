                    ...
                    <form method="POST" action="<?php echo e(route('books.update',$book)); ?>" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col col-md-5">
                                <label>ISBN</label>
                              <input type="number" class="form-control" placeholder="ISBN" name="isbn" value="<?php echo e($book->isbn); ?>">
                            </div>
                            <div class="col col-md-6">
                                <label>Name</label>
                              <input type="text" class="form-control" placeholder="Name" name="name" value="<?php echo e($book->name); ?>">
                            </div>
                          </div><br/>
                          <div class="row">
                            <div class="col col-md-5">
                                <label>Edition</label>
                                <input type="text" class="form-control" placeholder="Edition" name="edition" value="<?php echo e($book->edition); ?>">
                            </div>
                            <div class="col col-md-6">
                                <label>Author</label>
                                <input type="text" class="form-control" placeholder="Author" name="author" value="<?php echo e($book->author); ?>">
                            </div>
                          </div><br/>                          
                            <div class="form-group col-md-4">
                                <label>Length</label>
                                <input type="number" class="form-control" placeholder="Length" name='length' value="<?php echo e($book->length); ?>">
                            </div>
